            ...
            try
            {
                ...
                if (this.achievements.Checked == true)
                {
                    using (var file = new FileStream(TazFolderPath + "\\Taz.exe", FileMode.Open, FileAccess.ReadWrite))
                    {
                        ...
                        byte[] main_hook = { 0xE9, 0x40, 0xE5, 0x12, 0x00 };
                        file.Write(main_hook, 0, main_hook.Length);

                        // comp_hook
                        file.Position = 0xCD830;
                        byte[] comp_hook = { 0xE9, 0xE3, 0x85, 0x10, 0x00 };
                        file.Write(comp_hook, 0, comp_hook.Length);

                        // suit_hook
                        file.Position = 0x30DE7;
                        byte[] suit_hook = { 0xE9, 0x3C, 0x54, 0x1A, 0x00 };
                        file.Write(suit_hook, 0, suit_hook.Length);

                        // state_hook
                        file.Position = 0xD99BC;
                        byte[] state_hook = { 0xE9, 0x79, 0xC9, 0x0F, 0x00 };
                        file.Write(state_hook, 0, state_hook.Length);

                        // lev_hook
                        file.Position = 0xD255D;
                        byte[] lev_hook = { 0xE9, 0xB1, 0x3E, 0x10, 0x00, 0x90, 0x90 };
                        file.Write(lev_hook, 0, lev_hook.Length);

                        // touch_hook
                        file.Position = 0x1172A2;
                        byte[] touch_hook = { 0xE9, 0x7D, 0xF1, 0x0B, 0x00 };
                        file.Write(touch_hook, 0, touch_hook.Length);

                        // kill_hook
                        file.Position = 0x183B1;
                        byte[] kill_hook = { 0xE9, 0xC5, 0xE0, 0x1B, 0x00, 0x90 };
                        file.Write(kill_hook, 0, kill_hook.Length);

                        // save_hook
                        file.Position = 0xA24F0;
                        byte[] save_hook = { 0xE9, 0xA0, 0x42, 0x13, 0x00 };
                        file.Write(save_hook, 0, save_hook.Length);

                        // end_hook
                        file.Position = 0x90B52;
                        byte[] end_hook = { 0xE9, 0x5F, 0x5C, 0x14, 0x00 };
                        file.Write(end_hook, 0, end_hook.Length);

                        // poster_hook
                        file.Position = 0xCDB50;
                        byte[] poster_hook = { 0xE9, 0x93, 0x8C, 0x10, 0x00, 0x90 };
                        file.Write(poster_hook, 0, poster_hook.Length);

                        // sand_hook
                        file.Position = 0x7F6B1;
                        byte[] sand_hook = { 0xE9, 0x3D, 0x71, 0x15, 0x00 };
                        file.Write(sand_hook, 0, sand_hook.Length);

                        // gold_hook
                        file.Position = 0x7F7F5;
                        byte[] gold_hook = { 0xE9, 0x13, 0x71, 0x15, 0x00, 0x90, 0x90, 0x90 };
                        file.Write(gold_hook, 0, gold_hook.Length);

                        // thwap_hook
                        file.Position = 0x55252;
                        byte[] thwap_hook = { 0xE9, 0xB9, 0x17, 0x18, 0x00 };
                        file.Write(thwap_hook, 0, thwap_hook.Length);

                        // Achievements.CEA
                        file.Position = 0x1D5CF8;
                        byte[] injectionAch = {  };
