        ...
        */
        ...
        private void listViewActors_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (listViewActors.SelectedItems.Count > 0)
            {
                ...
                labelHint.Text = listViewActors.SelectedItems[0].ToolTipText;
                AdvancedActorCheat();
            }
        }
        ...
        private void AdvancedActorCheat()
        {
            ...
            //byte[] tazinjectionflag = { 0x02 };
            //checkAndWrite((IntPtr)0x00655510, tazinjectionflag, tazinjectionflag.Length, new IntPtr());

            // Wait for next game cycle
            ...
            if (actor == "Agent")
            {
                ...
                byte[] code = {  };
            ...
            else if (actor == "Crash Helmet")
            {
                // CostumeCrashHelmet.CEA
                byte[] data = { 0x63, 0x68, 0x65, 0x61, 0x74, 0x73, 0x00, 0x63, 0x6F, 0x73, 0x74, 0x75, 0x6D, 0x65, 0x5C, 0x63, 0x72, 0x61, 0x73, 0x68, 0x68, 0x65, 0x6C, 0x6D, 0x65, 0x74, 0x2E, 0x6F, 0x62, 0x65, 0x00 };
                checkAndWrite((IntPtr)0x00731380, data, data.Length, new IntPtr());
                byte[] code = { 0x6A, 0x01, 0x68, 0x80, 0x13, 0x73, 0x00, 0xE8, 0xF4, 0x9D, 0xEA, 0xFF, 0x83, 0xC4, 0x08, 0x6A, 0x00, 0x68, 0x80, 0x13, 0x73, 0x00, 0x68, 0x87, 0x13, 0x73, 0x00, 0xE8, 0x90, 0xC0, 0xE7, 0xFF, 0x83, 0xC4, 0x0C, 0x6A, 0x03, 0x6A, 0x00, 0x6A, 0x00, 0x6A, 0x00, 0x68, 0xE8, 0x0F, 0x63, 0x00, 0x68, 0x87, 0x13, 0x73, 0x00, 0x8B, 0x05, 0xC0, 0x8B, 0x6C, 0x00, 0x50, 0xE8, 0x3F, 0x0F, 0xE8, 0xFF, 0x83, 0xC4, 0x1C, 0xC3 };
                checkAndWrite((IntPtr)0x005F6900, code, code.Length, new IntPtr());
            }
            else if (actor == "Digital Watch")
            {
                // CostumeDigitalWatch.CEA
                byte[] code = { 0x83, 0x0D, 0x28, 0x8E, 0x6C, 0x00, 0x08, 0x8B, 0x05, 0xC0, 0x8B, 0x6C, 0x00, 0x8B, 0x88, 0xCC, 0x01, 0x00, 0x00, 0x31, 0xD2, 0x8A, 0x91, 0x0C, 0x01, 0x00, 0x00, 0x52, 0x50, 0xE8, 0xDE, 0x99, 0xE3, 0xFF, 0x83, 0xC4, 0x08, 0xC3 };
                checkAndWrite((IntPtr)0x005F6900, code, code.Length, new IntPtr());
            }
            ...
            else if (actor == "Wilson")
            {
                // CostumeWilson.CEA
                byte[] code = { 0x81, 0x0D, 0x28, 0x8E, 0x6C, 0x00, 0x00, 0x08, 0x00, 0x00, 0xC3 };
                checkAndWrite((IntPtr)0x005F6900, code, code.Length, new IntPtr());
            }
            else
            {
            ...
            byte[] injectionflag = { 0x02 }; // InjectionPre + InjectionPost
            checkAndWrite((IntPtr)0x00655510, injectionflag, injectionflag.Length, new IntPtr());
