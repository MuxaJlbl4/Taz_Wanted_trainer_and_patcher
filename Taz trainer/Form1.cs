    ...
    public partial class form : System.Windows.Forms.Form
    {
        ...
        private void debugMenu_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (state[0] == 0)
            {
                ...
                checkAndWrite((IntPtr)0x0073133C, injectionFlag, injectionFlag.Length, new IntPtr());
        ...
        private void SingleCallInitialise()
        {
            ...
            if (init[0] == 0)
            {
                ...
                byte[] singleCallCode = { 0x8B, 0x05, 0x3C, 0x13, 0x73, 0x00, 0x85, 0xC0, 0x0F, 0x84, 0x0F, 0x00, 0x00, 0x00, 0xE8, 0x6D, 0x00, 0x00, 0x00, 0xC7, 0x05, 0x3C, 0x13, 0x73, 0x00, 0x00, 0x00, 0x00, 0x00, 0x68, 0xB8, 0xA0, 0x6F, 0x00, 0xE9, 0x3D, 0x0F, 0xEB, 0xFF };
                checkAndWrite((IntPtr)0x005F6880, singleCallCode, singleCallCode.Length, new IntPtr());

                byte[] singleCallCodeInjection = { 0xE9, 0x9C, 0xF0, 0x14, 0x00 };
