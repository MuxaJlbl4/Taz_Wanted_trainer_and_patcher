            ...
            try
            {
                ...
                if (this.extraDebug.Checked == true)
                {
                    ...
                    using (var file = new FileStream(TazFolderPath + "\\Taz.exe", FileMode.Open, FileAccess.ReadWrite))
                    {
                        ...
                        byte[] ahdata = Encoding.ASCII.GetBytes("cheats\0costume\\agenthat.obe\0costume\\agentshades.obe\0costume\\agentwatch.obe\0costume\\crashhelmet.obe\0");
                        file.Position = 0x1F6A80;
                        file.Write(ahdata, 0, ahdata.Length);

                        //agent and helmet costumes code
                        byte[] ahcode = new byte[] {  };
                ...
                else 
                {
                    ...
                    using (var file = new FileStream(TazFolderPath + "\\Taz.exe", FileMode.Open, FileAccess.ReadWrite))
                    {
                        ...
                        byte[] ahdata = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
                        file.Position = 0x1F6A80;
                        file.Write(ahdata, 0, ahdata.Length);

                        //restore costumes code
                        byte[] ahcode = new byte[] {  };
                        file.Position = 0x1F6B00;
                        file.Write(ahcode, 0, ahcode.Length);
        ...
        */
        ...
        private void AdvancedActorCheat()
        {
            ...
            else if (actor == "Crash Helmet")
            {
                ...
                checkAndWrite((IntPtr)0x00731380, data, data.Length, new IntPtr());
                byte[] code = { 0x6A, 0x01, 0x68, 0x80, 0x13, 0x73, 0x00, 0xE8, 0xF4, 0x9D, 0xEA, 0xFF, 0x83, 0xC4, 0x08, 0x6A, 0x00, 0x68, 0x80, 0x13, 0x73, 0x00, 0x68, 0x87, 0x13, 0x73, 0x00, 0xE8, 0x90, 0xC0, 0xE7, 0xFF, 0x83, 0xC4, 0x0C, 0x8B, 0x05, 0xC0, 0x8B, 0x6C, 0x00, 0x8B, 0x88, 0xCC, 0x01, 0x00, 0x00, 0x31, 0xD2, 0x8A, 0x91, 0x0C, 0x01, 0x00, 0x00, 0x6A, 0x10, 0x50, 0xE8, 0xC1, 0x99, 0xE3, 0xFF, 0x83, 0xC4, 0x08, 0xC3 };
                checkAndWrite((IntPtr)0x005F6900, code, code.Length, new IntPtr());
            }
